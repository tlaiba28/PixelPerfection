		...
		<form action="/admin/products/update/${product.id}" method="post">
			<div class="row">
				...
				<div class="form-group">
                    ...
                    <textarea class="form-control border border-success" rows="4" name="description"  value="${product.description}" placeholder="Product Details">${product.description}</textarea>
                </div>

					<p>Product Image</p>
					<div class="custom-file">
                        <input type="file" class="custom-file-input" name="productImage" value="${product.image}" accept="image/jpeg, image/png" id="productImage" onchange="loadFile(event)" required>
